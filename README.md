...
| Site Clearance | [clearance.kardashevlabs.org](https://clearance.kardashevlabs.org) | Draw a search area in ERCOT; county-level strong/mixed/weak estimate from GIS queue, measured timelines, and LMP stress. Public data only. |
